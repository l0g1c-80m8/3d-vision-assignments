...
def set_arguments(parser):
    ...
    parser.add_argument('--data_dir', action='store', type=str,
                        default='./assets/assignment2/Benchmarking_Camera_Calibration_2008/fountain-P11/images',
    ...
    parser.add_argument('--out_dir', action='store', type=str,
                        default='./assets/assignment2/Benchmarking_Camera_Calibration_2008/fountain-P11',
    ...
    parser.add_argument('--save_results', action='store', type=str, default=False,
                        dest='save_results',
                        help='[True|False] whether to save images with keypoints drawn on them (default: False)')
