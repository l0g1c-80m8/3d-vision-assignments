...
def set_arguments(parser):
    ...
    parser.add_argument('--data_dir', action='store', type=str,
                        default='./assets/assignment2/Benchmarking_Camera_Calibration_2008', dest='data_dir',
    ...
    parser.add_argument('--outlier_thres', action='store', type=float, default=.9,
                        dest='outlier_thres',
                        help='threhold value of outlier to be used in fundamental matrix estimation (default: 0.9)')
    ...
    parser.add_argument('--pnp_method', action='store', type=str, default='SOLVEPNP_DLS',
                        dest='pnp_method',
                        help='[SOLVEPNP_DLS|SOLVEPNP_EPNP|..] method used for PnP estimation, see OpenCV doc for more options (default: SOLVEPNP_DLS')
